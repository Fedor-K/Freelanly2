...
export const metadata: Metadata = {
  ...
  description: 'Every feature in Freelanly: real-time gig discovery, AI-written applications with a reviewer pass, CV attached to every send, pipeline tracking, inbox routing, and more.',
  ...
  <div className="container">
    ...
    <div className="feat-cards">
      ...
      <div className="feat-card reveal">
        ...
        <h3>Your CV on every application</h3>
        <p>Your r&eacute;sum&eacute; is attached to every send automatically — the recruiters&apos; #1 ask. No file uploaded? We build a clean CV from your profile so you never apply empty-handed.</p>
      </div>
      <div className="feat-card reveal">
        <div className="icon">
