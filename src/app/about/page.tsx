  ...
  <div className="container" style={{maxWidth: '920px'}}>
    ...
    <div className="reveal">
      ...
      <details className="faq-item-acc">
        ...
        <div className="a">Signing up and browsing your matched projects is free — no credit card. Applying is PRO, $5/month: up to 20 applications a day and a morning ready-queue, with your CV attached to every send. Cancel anytime from your billing page, in two clicks.</div>
      </details>
      <details className="faq-item-acc">
        <summary>
