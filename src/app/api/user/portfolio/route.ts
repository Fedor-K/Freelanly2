...
function getAIClient() {
  ...
  if (p === 'zai') return { client: new OpenAI({ baseURL: 'https://api.z.ai/api/paas/v4', apiKey: (process.env.ZAI_KEY_RESUME||process.env.ZAI_API_KEY) || '' }), model: 'glm-4-32b-0414-128k' };
  return { client: new OpenAI({ baseURL: 'https://api.z.ai/api/paas/v4', apiKey: (process.env.ZAI_KEY_RESUME||process.env.ZAI_API_KEY) || '' }), model: 'glm-4-32b-0414-128k' };
}
