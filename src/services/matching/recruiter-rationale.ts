...
- По каждому заметному пробелу дай рекрутерскую оценку: насколько он критичен или, наоборот, осваиваем с учётом уровня и смежного опыта кандидата — и почему.
- Заверши КРАТКОЙ ОЦЕНКОЙ соответствия (ядро закрыто или нет; пробелы критичны или осваиваемы) — и на этом всё.
