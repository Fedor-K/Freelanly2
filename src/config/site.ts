export const siteConfig = {
  name: 'Freelanly',
  description: 'Personal AI assistant for vacancies and projects application. Finds fresh matched roles and drafts a tailored cover letter for each — you review and send.',
  ...
  keywords: [
    ...
    'freelance project applications',
...
export const countries = [
  ...
  { slug: 'nigeria', name: 'Nigeria', code: 'NG', flag: '🇳🇬' },
  { slug: 'egypt', name: 'Egypt', code: 'EG', flag: '🇪🇬' },
  { slug: 'pakistan', name: 'Pakistan', code: 'PK', flag: '🇵🇰' },
  { slug: 'philippines', name: 'Philippines', code: 'PH', flag: '🇵🇭' },
  { slug: 'argentina', name: 'Argentina', code: 'AR', flag: '🇦🇷' },
  { slug: 'colombia', name: 'Colombia', code: 'CO', flag: '🇨🇴' },
  { slug: 'south-africa', name: 'South Africa', code: 'ZA', flag: '🇿🇦' },
  { slug: 'kenya', name: 'Kenya', code: 'KE', flag: '🇰🇪' },
  { slug: 'indonesia', name: 'Indonesia', code: 'ID', flag: '🇮🇩' },
  { slug: 'bangladesh', name: 'Bangladesh', code: 'BD', flag: '🇧🇩' },
  { slug: 'turkey', name: 'Turkey', code: 'TR', flag: '🇹🇷' },
  { slug: 'japan', name: 'Japan', code: 'JP', flag: '🇯🇵' },
  { slug: 'south-korea', name: 'South Korea', code: 'KR', flag: '🇰🇷' },
  { slug: 'uae', name: 'UAE', code: 'AE', flag: '🇦🇪' },
  { slug: 'saudi-arabia', name: 'Saudi Arabia', code: 'SA', flag: '🇸🇦' },
  { slug: 'israel', name: 'Israel', code: 'IL', flag: '🇮🇱' },
  { slug: 'singapore', name: 'Singapore', code: 'SG', flag: '🇸🇬' },
  { slug: 'malaysia', name: 'Malaysia', code: 'MY', flag: '🇲🇾' },
  { slug: 'vietnam', name: 'Vietnam', code: 'VN', flag: '🇻🇳' },
  { slug: 'thailand', name: 'Thailand', code: 'TH', flag: '🇹🇭' },
  { slug: 'romania', name: 'Romania', code: 'RO', flag: '🇷🇴' },
  { slug: 'ukraine', name: 'Ukraine', code: 'UA', flag: '🇺🇦' },
  { slug: 'denmark', name: 'Denmark', code: 'DK', flag: '🇩🇰' },
  { slug: 'belgium', name: 'Belgium', code: 'BE', flag: '🇧🇪' },
  { slug: 'austria', name: 'Austria', code: 'AT', flag: '🇦🇹' },
  { slug: 'norway', name: 'Norway', code: 'NO', flag: '🇳🇴' },
  { slug: 'finland', name: 'Finland', code: 'FI', flag: '🇫🇮' },
  { slug: 'new-zealand', name: 'New Zealand', code: 'NZ', flag: '🇳🇿' },
  { slug: 'ghana', name: 'Ghana', code: 'GH', flag: '🇬🇭' },
