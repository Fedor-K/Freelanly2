...
└────────┬────────────────────────────────────────────────────┘
         ...
         ▼
┌─────────────────────────────────────────────────────────────┐
│  STEP 4: DUAL DISPLAY FORMAT (NO FAKE GENERATION!)          │
│                                                             │
│  ПРОБЛЕМА: Если генерим красивое описание, а юзер           │
│  переходит на LI и видит "DM me bro" — теряем доверие.      │
│                                                             │
│  РЕШЕНИЕ: Показываем ОБА варианта:                          │
│                                                             │
│  ┌─────────────────────────────────────────────────────┐    │
...
│  ├─────────────────────────────────────────────────────┤    │
│  │  💬 ORIGINAL POST                                   │    │
│  │  "Hey network! 🚀 We're growing at Acme Corp!      │    │
│  │   Looking for a Senior React Developer..."          │    │
│  │                                                     │    │
│  │  Posted by John Smith · Jan 15, 2024               │    │
│  ├─────────────────────────────────────────────────────┤    │
│  │  [Open on LinkedIn]  [Apply via Email]             │    │
│  └─────────────────────────────────────────────────────┘    │
│                                                             │
│  Для Google Schema `description` = оригинальный пост        │
│  (он валиден, просто короткий — это ОК)                     │
│                                                             │
│  AI используется ТОЛЬКО для extraction, НЕ для генерации    │
└────────┬────────────────────────────────────────────────────┘
         │
         ▼
┌─────────────────────────────────────────────────────────────┐
