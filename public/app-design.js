...
const NAV = [
  ...
  { label: 'CONTENT', items: [
    ...
    { id: 'resumes',     href: 'resumes.html',    label: 'Resumes',       icon: 'file',    count: '5' },
...
const ICONS = {
  ...
  file:    '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6"/><path d="M8 13h8M8 17h5"/>'
};
